...
export const JUNIOR_EVENTS = [
  // ───────── 第 0 幕：他出現 ─────────
  {
    ...
    effects: { teaching: 2 },
    bond: { junior: 3 },
    log: '下刀後他站在門口跟你鞠躬，說「{學長}對不起」。你也在那個位置站過，那時候沒有人回你話，你就一直站著。',
  },
  {
    id: 'j_teach_or_not',
    scene: 'oncall',
    ...
    weight: 4,
    cond: (s) => J(s).stage === 0 && s.age >= 38,
    text: '許士杰跟你的刀跟了三個月。他遞手機過來，是自己在值班室錄的打結影片，問你哪裡不對。檔案時間是凌晨兩點四十分。',
    choices: [
      {
        label: '看完，一格一格指給他看。',
