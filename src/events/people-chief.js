...
export const CHIEF_EVENTS = [
  ...
  },
  {
    ...
    once: true,
    weight: 3,
    cond: (s) => C(s).stage >= 2 && s.attrs.clinical >= 55,
  ...
  },
  {
    ...
    once: true,
    weight: 4,
    cond: (s) => C(s).stage >= 3 && !C(s).succeeded && s.age >= 56,
