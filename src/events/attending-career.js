...
export const ATTENDING_CAREER_EVENTS = [
    ...
    choices: [
      {
        ...
        // 審稿不是教學服務，婉拒也不該扣教學分數；而且同一幕的另一個選項
        // 明寫「署名是匿名」——審稿本來就不會在期刊上露臉。
        // 真正少掉的是跟那位編輯往來的機會，那種東西不登在任何地方。
        effects: { self: 6 },
        memory: '期刊請你審一篇跟你手上題目重疊的稿，你婉拒了，並告訴編輯重疊在哪裡。',
        log: '編輯回了一句「謝謝你講清楚」，然後換了人審。你少掉的是往後跟他往來的那條線——匿名審稿本來就不會有人知道你做過什麼，只有他知道。下次他想到誰，就是想不到你。',
      },
      {
        label: '照規矩審，該給的意見給。',
  ...
  },
  {
    ...
    text: '收案是住院醫師做的，統計是你跑的，題目是你想的。投稿前一晚他小聲問：「老師，第一作者……可以掛我嗎？我要申請專科。」',
    choices: [
      {
        label: '給他。',
        effects: { papers: 15, teaching: 3, self: 4 },
        log: '你掛通訊作者。那年他順利提出申請。你的升等表上，這篇的點數要乘上一個小於一的係數。',
      },
      {
        label: '你也需要這一篇。',
  ...
  },
  {
    ...
    text: '保健食品廠商來信，要借你的頭銜和白袍拍一支影片，念一段稿：「身為外科醫師，我自己也在吃。」十五萬。',
    choices: [
      {
        label: '拒絕。',
        effects: { self: 5 },
        log: '你回信說這個成分沒有足夠證據。對方隔週找到另一位主治，那支影片現在還在播。',
      },
      {
        label: '接。房貸不會自己還。',
        effects: { money: 15, self: -10 },
        log: '拍了兩小時，NG 六次，都卡在「我自己也在吃」那一句。上架之後，門診有病人拿手機問你這個是不是真的有效。',
      },
    ],
  },
  {
